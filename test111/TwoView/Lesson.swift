...
struct Lesson: Codable {
    ...
    init(number: Int, time: String, subject: String, teacher: String, room: String, type: String, color: UIColor, eiosLink: String? = nil) {
        self.number = number
        self.time = time
    ...
    init(from decoder: Decoder) throws {
        ...
        // Декодируем цвет как строку и конвертируем в UIColor (используем существующий init(hex:))
...
// Расширение для UIColor: только метод для получения hex-строки
extension UIColor {
